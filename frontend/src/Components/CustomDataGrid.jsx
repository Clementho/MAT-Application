...
const CustomDataGrid = ({rows, columns, isLoading, extraButton}) => {
    ...
    function CustomGridMenuItem(props) {
        const itemProps = {
          colDef: props.colDef,
        ...
        <Box>
            <DataGrid
                ...
                slots={{
                    ...
                    columnMenu: CustomGridMenuItem,
                    pagination: CustomPagination,
                }}
                localeText={{
                    toolbarQuickFilterPlaceholder: "Search by Name...",
